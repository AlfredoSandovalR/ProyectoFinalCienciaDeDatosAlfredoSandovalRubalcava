...
datosTotalesHigado         = dfCancer['c220-c249m'].describe()
datosTotalesPulmon         = dfCancer['c340-c349m'].describe()
datosTotalesMama           = dfCancer['c500-c509m'].describe()
datosTotalesCervicouterino = dfCancer['c530-c55Xm'].describe()
datosTotalesLeucemia       = dfCancer['c901-c959m'].describe()
#print(datosTotalesHigado)
#print(datosTotalesPulmon)
#print(datosTotalesMama)
#print(datosTotalesCervicouterino)
#print(datosTotalesLeucemia)
...
#sns.jointplot(x='edad', y='c220-c249m', data=c220_c959m13_18ConAcumular,label="Def. por cáncer de hígado")
#sns.jointplot(x='edad', y='c340-c349m', data=c220_c959m13_18ConAcumular,label="Def. por cáncer de pulmón")
#sns.jointplot(x='edad', y='c500-c509m', data=c220_c959m13_18ConAcumular,label="Def. por cáncer de mama")
#sns.jointplot(x='edad', y='c530-c55Xm', data=c220_c959m13_18ConAcumular,label="Def. de cáncer cervicouterino")
#sns.jointplot(x='edad', y='c901-c959m', data=c220_c959m13_18ConAcumular,label="Def. Leucemia")
#plt.show()
